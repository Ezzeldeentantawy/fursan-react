    ...
    useEffect(() => {
        const fetchPendingJobs = async () => {
            try {
                ...
                // Ensure we are setting an array even if data is nested
                setJobs(Array.isArray(res.data.data) ? res.data.data : res.data.jobs);
                console.log("Fetched pending jobs:", res.data);
            } catch (err) {
